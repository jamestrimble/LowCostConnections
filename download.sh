curl -o downloads/ryanair.json http://www.ryanair.com/en/booking/feed
curl -o downloads/easyjet.js http://www.easyjet.com/EN/linkedAirportsJSON?20100310
...
# (From which the route details need to be extracted by hand)